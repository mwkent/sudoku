...
public class SudokuSolver {
	...
	private void checkForInvalidBoard() {
		if (!board.isValid()) {
			throw new IllegalStateException("The board provided is invalid:\n"
					+ board);
		}
	}
